...
<head>
    ...
    <link rel="canonical" href="https://neuhub.codeven.co/projeler/piyalepasa-istanbul">

    <title>Piyalepasa Istanbul</title>
    <meta property="og:title" content="Piyalepasa Istanbul">
    <meta property="og:locale" content="tr">
    <meta property="og:url" content="https://neuhub.codeven.co/projeler/piyalepasa-istanbul">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Piyalepasa Istanbul">


    <link rel="stylesheet" href="https://neuhub.codeven.co/front/css/fancybox.css" />
    <link rel="stylesheet" href="https://neuhub.codeven.co/front/css/swiper-bundle.min.css" />
    <link rel="stylesheet" href="https://neuhub.codeven.co/front/css/main.min.css" />
    <link href="https://fonts.cdnfonts.com/css/sedan" rel="stylesheet" />
    <style>
        @import url("https://fonts.cdnfonts.com/css/sedan");
    </style>
    <link rel="stylesheet" href="https://neuhub.codeven.co/front/css/intlTelInput.css" />
                    ...
                    <div class="card card-body bg-transparent border-0 px-0 pt-0 ps-3 pb-3">
                        <a href="https://polatgayrimenkul.com.tr/hakkimizda" class="d-block fs-15 text-gray-500 ls-1 mb-2 d-flex align-items-center gap-3">
                            <svg class="text-gray-400" width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="6" y="3" width="3" height="3" transform="rotate(90 6 3)" fill="currentcolor"></rect>
                                <rect x="3" y="6" width="3" height="3" transform="rotate(90 3 6)" fill="currentcolor"></rect>
                                <rect x="3" width="3" height="3" transform="rotate(90 3 0)" fill="currentcolor"></rect>
                            </svg>
                            Hakkımızda</a>
            ...
            <div class="w-100 h-100 d-flex flex-md-row flex-column position-relative gap-lg-0 gap-4">
                ...
                <div class="hero-image-content carsi position-relative flex-1">
                    <div class="position-absolute start-0 top-0 z-3 ms-n5">
                        <img src="https://neuhub.codeven.co/front/img/c-birds.png" class="h-250px ms-n5" data-parallax="10" />
                    </div>
                    <div class="hero-img-list swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/7.jpg" data-fancybox>
                                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/7.jpg" class="w-100 h-700px pp-hero-img object-fit-cover hero-image" />
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/8.jpg" data-fancybox>
                                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/8.jpg" class="w-100 h-700px pp-hero-img object-fit-cover hero-image" />
                                </a>
                            </div>
                        </div>
            ...
            <div class="position-relative">
                <div class="row g-0">
                    <div class="col-lg-8 col-md-6">
                        <div class="position-relative">
                            <img src="https://neuhub.codeven.co/front/img/c-birds3.png" class="start-0 top-0 h-200px ms-5 mt-n5 position-absolute z-3" data-parallax="-10" />
                            <img src="https://neuhub.codeven.co/front/img/c-leaf2.png" class="start-50 top-100 h-150px ms-5 mt-n5 position-absolute z-3" data-parallax="-10" />
                            <div class="position-absolute end-0 bottom-0 me-n5">
                                <img src="https://neuhub.codeven.co/front/img/tree.png" class="h-500px me-n5 mb-n2 d-md-block d-none" />
                            </div>
                            <img src="https://neuhub.codeven.co/front/img/c1.png" class="w-100 h-450px c-img object-fit-cover" />
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <img src="https://neuhub.codeven.co/front/img/c2.png" class="w-100 h-450px c-img object-fit-cover" />
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="py-md-5 py-4 px-md-0 px-3 position-relative h-100">
                        <div class="position-absolute start-100 translate-middle-x bottom-0 d-lg-block d-none">
                            <img src="https://neuhub.codeven.co/front/img/union.svg" alt="" />
                        </div>
...
<section id="hikaye" class="pt-lg-5 pt-4 c-big position-relative">
    <div class="c-big-image position-relative">
        <div class="c-big-text text-center position-absolute start-0 end-0 top-0 mt-xl-5">
            <img src="https://neuhub.codeven.co/front/img/c-birds3.png" class="position-absolute start-0 top-0 mt-5 ms-5 h-200px" data-parallax="-30" />
            <img src="https://neuhub.codeven.co/front/img/c-birds4.png" class="position-absolute end-0 top-50 mt-5 h-200px d-md-block d-none" data-parallax="30" />
        ...
        <img src="https://neuhub.codeven.co/front/img/carsi2.jpg" class="w-100" />
    </div>
</section>
<!-- end #section -->
...
<section id="galeri" class="py-lg-5 py-4 position-relative">
    <div class="container position-relative z-2">
        ...
        <div class="row g-md-4 g-2">
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/carsi/1.png" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/carsi/1.png" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/1.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/1.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/2.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/2.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/3.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/3.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/4.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/4.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/5.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/5.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/6.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/6.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/7.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/7.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/8.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/8.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/carsi/3.png" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/carsi/3.png" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/carsi/5.png" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/carsi/5.png" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/carsi/6.png" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/carsi/6.png" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/carsi/7.png" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/carsi/7.png" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/carsi/8.png" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/carsi/8.png" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/carsi/9.png" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/carsi/9.png" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/14.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/14.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="https://neuhub.codeven.co/front/img/piyalepasa-proje/15.jpg" data-fancybox="gallery">
                    <img src="https://neuhub.codeven.co/front/img/piyalepasa-proje/15.jpg" class="w-100 h-300px object-fit-cover" />
                </a>
            </div>
        </div>
    </div>
...
<div class="location-image position-relative h-500px">
    <img src="https://neuhub.codeven.co/front/img/yp.png" class="position-absolute end-0 top-50 translate-middle-y z-1 h-700px" />
        ...
        <div class="row g-0">
            ...
            <div class="col">
                <a href="https://iett.istanbul/Announcement/Detail/2660">
                    <img src="https://neuhub.codeven.co/front/img/nerede.png" class="h-125px" />
                </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="w-100 d-flex align-items-center h-100 position-relative z-2">
                        <div class="bg-piyale-color px-4 text-white mt-lg-0 mt-3 w-100 h-100 c-map-box position-relative">
                            ...
                            <div class="mb-lg-5 mb-4">
                                ...
                                <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="69040129190605081d1006070c1d0004470a0604">[email&#160;protected]</a></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content rounded-0 bg-black">
            ...
            <div class="modal-body pt-0">
                <form action="" class="hero-form">
                    ...
                    <div class="form-group mb-3">
                        <input id="phone2" name="phone" type="tel" style="padding-left: 0px !important;" class="form-control px-0 bg-transparent ls-1 rounded-0 border-0 border-bottom border-gray-700 text-white" placeholder="TELEFON NUMARANIZ *" />
                    </div>
                    <div class="form-group mb-3">
                        <select name="" id="" class="form-select px-0 bg-transparent ls-1 rounded-0 border-0 border-bottom border-gray-700 text-white">
                            ...
                            <option value="">PİYALEPAŞA İSTANBUL PREMIUM</option>
                            <option value="">PİYALEPAŞA İSTANBUL</option>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label fs-13 text-white" for="inlineCheckbox4"><a href="https://neuhub.codeven.co/front/files/aydinlatma-beyani.pdf" target="_blank" class="text-decoration-underline">Aydınlatma Metni'ni</a> ve <a href="https://neuhub.codeven.co/front/files/acik-riza-beyani.pdf" class="text-decoration-underline" target="_blank">Açık Rıza Beyanı'nı</a> kabul ediyorum.</label>
                    </div>
        ...
        <div class="container py-xl-5">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-11">
                    ...
                    <p class="fs-5 text-gray-500 ls-3 text-center">PROJELERİMİZİ YAKINDAN TANIMAK İSTERSENİZ</p>
                </div>
            </div>
        </div>
    </div>
...
<footer class="bg-black p-xl-5 p-4">
    <div class="px-xl-4 py-xl-3">
                ...
                <div class="col-lg-11">
                    <div class="d-flex align-items-center flex-lg-row flex-column gap-lg-5 gap-4">
                        <a href="#" class="logo d-block flex-shrink-0">
                            <img src="https://neuhub.codeven.co/front/img/logo.png" class="h-20px" />
                        </a>
                    ...
                    <div class="row g-xl-5 g-4">
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex gap-4 flex-wrap justify-content-lg-start justify-content-center">
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Hakkımızda</a>
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Tarihçemiz</a>
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Kurumsal Yönetim</a>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex gap-4 flex-wrap justify-content-lg-start justify-content-center">
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Polat Levent Exclusive</a>
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Piyalepaşa İstanbul Premium</a>
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Piyalepaşa İstanbul</a>
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Polat Akatlar</a>
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">City Pearl</a>
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Polat Göztepe</a>
                                <a href="#" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline">Duna Pearl</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex gap-4 flex-wrap justify-content-lg-start justify-content-center">
                                ...
                                <a href="https://neuhub.codeven.co/front/files/0509_PolatGayrimenkul_YansimaRaporu_Ocak23_Nisan24.pdf" class="d-flex align-items-center gap-4 fs-16 text-white hover-text-underline" target="_blank">Küpürler</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="phone-mail border-start border-white border-opacity-15 px-xl-4 pe-0 pt-xl-0 pt-4 h-100 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-xl-column flex-lg-row flex-column gap-xl-3 gap-md-4 gap-3 align-items-lg-start align-items-center">
                            ...
                            <a href="/cdn-cgi/l/email-protection#b0d9ded6dff0c0dfdcd1c4d7d1c9c2d9ddd5dedbc5dc9ed3dfdd9ec4c2" class="d-flex align-items-center gap-3 text-white">
                                ...
                                <span class="fs-5"><span class="__cf_email__" data-cfemail="670e0901082717080b061300061e150e0a02090c120b4904080a491315">[email&#160;protected]</span></span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center gap-3">
                <a href="https://neuhub.codeven.co/front/files/cerez-politikasi.pdf" target="_blank" class="d-block fs-16 text-white">Çerez Politikası</a>
            </div>
        </div>
    </div>
</footer>
...
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="https://neuhub.codeven.co/front/js/jquery-3.7.1.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.1/dist/umd/popper.min.js"></script>
<script src="https://neuhub.codeven.co/front/js/bootstrap.min.js"></script>
<script src="https://neuhub.codeven.co/front/js/fancybox.umd.js"></script>
<script src="https://neuhub.codeven.co/front/js/swiper-bundle.min.js"></script>
<script src="https://neuhub.codeven.co/front/js/main.js"></script>
<script src="https://neuhub.codeven.co/front/js/intlTelInput.min.js"></script>
