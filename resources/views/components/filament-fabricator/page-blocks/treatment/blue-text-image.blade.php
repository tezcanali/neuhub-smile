@aware(['page'])
<section class="bg-primary pt-lg-5 pt-4 position-relative">
    ...
    <div class="bg-gray-200 position-absolute start-0 end-0 bottom-0 h-150px d-xl-block d-none"></div>
    <div class="container-xxl position-relative">
        <div class="d-md-flex d-none align-items-center gap-3 pb-lg-5 pb-4 position-relative z-1 text-white">
            @if($title)
                <div class="icon">
        ...
        <div class="row g-4">
            <div class="col-lg-6 order-md-1 order-2 text-md-start text-center">
                ...
                <div class="show-more-container d-md-none d-flex flex-column align-items-start">
                    <div class="show-more-content hide-more">
                        <div class="text-white">
                            {!! $content !!}
                        </div>
                    </div>
                    <button type="button" class="show-more-btn fs-14 fw-bold text-white mt-4 d-block hover-text-underline mb-4">Read More</button>
                </div>
            </div>
