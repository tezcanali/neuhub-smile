...
@if($doctorId)
    <div class="bg-white rounded-3 p-md-4 p-3">
        <div class="row g-4">
            <div class="col-lg-5">
                <img src="{{ \Illuminate\Support\Facades\Storage::url($doctorId->image) }}" class="object-fit-cover rounded-1 w-100 h-400"/>
            </div>
            <div class="col-lg-7">
                <div class="p-md-4 p-2">
                    ...
                    <div class="d-flex align-items-center justify-content-md-start justify-content-center gap-md-3 gap-2 flex-wrap mt-4 pt-lg-2">
                        <a href="/doctors/{{ $doctorId->slug }}" class="btn btn-primary rounded-pill px-4 fs-18 fw-normal">Education and Experience</a>
                    </div>
                </div>
            </div>
        </div>
