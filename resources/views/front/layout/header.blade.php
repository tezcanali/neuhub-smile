    ...
    <div class="offcanvas-header px-4 pt-4 d-flex align-items-center justify-content-between">
        ...
        <button type="button" class="shadow-none px-0" data-bs-dismiss="offcanvas" aria-label="Close">
            <svg width="48" height="48" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M35.53 78L52.36 54.06L35.62 30.21H42.37L57.76 52.26H53.71L69.01 30.21H75.76L59.02 54.06L75.76 78H69.01L53.71 55.86H57.76L42.28 78H35.53Z" fill="#192D74" />
                <rect x="2" y="2" width="103" height="103" rx="51.5" stroke="#C2CCF2" stroke-width="4" />
            </svg>
        </button>
    </div>
    <div class="offcanvas-body p-0">
        <div class="mobile-menu-section p-4 pt-0 px-4">
            <div class="link-section">
                <div class="menu-box pb-3">
                    <div class="menu-box-item border-bottom border-white border-opacity-10">
                        ...
                        <div class="menu-box-item-content p-3" style="display: none">
                            <div class="d-flex flex-column gap-3 fs-15 ps-3 pb-3">
                ...
                <div class="menu-box pb-3">
                    <a href="#" class="d-block fs-4 fw-normal">Plastic Surgery Turkey</a>
                </div>
                <div class="menu-box pb-3">
                    <a href="#" class="d-block fs-4 fw-normal">Hair Transplant Turkey</a>
                </div>
                <div class="menu-box pb-3">
            ...
            <div class="d-flex flex-column gap-1">
                ...
                <a href="#" class="d-block fw-lighter"><span class="fw-normal">+44 (808) 175 47 46</span> - TOLL FREE LINE</a>
                <a href="#" class="d-block fw-lighter"><span class="fw-normal">+90 (545) 129 47 46</span> - WHATSAPP LINE</a>
            </div>
        </div>
    </div>
</div>
