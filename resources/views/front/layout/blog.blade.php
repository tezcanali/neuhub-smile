        ...
        <div class="container-xxl">
            ...
            <div class="blod-heading pt-md-3 pb-lg-4">
                <div class="title d-flex gap-3 text-white pb-4 mb-lg-2">
                    ...
                    <div class="fs-48 fw-semibold lh-sm">{{ $blog->title }}</div>
                </div>
                ...
                <div class="d-flex align-items-center gap-4">
                    <a href="#">
                        <svg width="53" height="49" viewBox="0 0 53 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.944743 24.8896L24.8896 0.944823L30.4767 6.53195L16.1098 20.8988L52.8252 20.8988L52.8252 28.8805L16.1098 28.8804L30.4767 43.2473L24.8896 48.8345L0.944743 24.8896Z" fill="#192D74" />
                        </svg>
                    </a>
                    <a href="#">
                        <svg width="53" height="49" viewBox="0 0 53 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M52.8346 24.8896L28.8897 48.8345L23.3026 43.2473L37.6695 28.8805L0.954101 28.8805L0.9541 20.8988L37.6695 20.8988L23.3026 6.53195L28.8897 0.944823L52.8346 24.8896Z" fill="#192D74" />
                        </svg>
                    </a>
                </div>
