...
<div class="hero-page w-100 h-450px overflow-hidden position-relative">
    <div class="container-xxl position-relative z-3 h-100 py-4">
        ...
        <div class="d-flex gap-3 mt-md-4 mt-3 text-primary">
            ...
            <div class="d-flex flex-column gap-1">
                <div class="fs-54 fw-bold text-primary">{{ $doctor->name }}</div>
                <div class="fs-4 fw-lighter">{{ $doctor->job_title }}</div>
            </div>
        </div>
    </div>
