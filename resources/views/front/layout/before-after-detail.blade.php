    ...
    <div class="container-xxl position-relative z-3 h-100 py-4 d-flex justify-content-center flex-column">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb text-text-primary dark mb-lg-3 mb-2">
                ...
                <li class="breadcrumb-item"><a href="/before-after">Before & After</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $beforeAfter->title }} Before & After</li>
            </ol>
        </nav>
        <div class="d-flex align-items-center gap-3 text-primary">
            ...
            <div class="fs-54 fw-bold text-primary">{{ $beforeAfter->title }} Before & After</div>
        </div>
    </div>
